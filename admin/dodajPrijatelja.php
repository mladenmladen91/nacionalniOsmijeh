       ...
       <div class="container">
          <div class="row">   
           <div class="col-lg-12 table_holder">
              <div class="col-lg-12">  
                  <span class="footer_title underline">DODAJ PRIJATELJA</span>
              </div>
                 
              <div class="col-lg-12 p-0" style="margin-top:50px">
                  <input type="hidden" class="tableName" value="prijatelji">
                  <input type="hidden" class="pageName" value="sacuvajPrijatelja">
                    <form class="contact_form p-0" id="infoForm">
                                 <div class="col-lg-8 form-group">
                                         ...
                                         <div class="col-lg-8 form-group">
                                             ...
                                             <input id="link" type="text" name="link" class="contact_inputs form-control form-control-lg link" required>
                                             <span class="form_result" style="color:#41bdd5; font-size:20px; display:none"></span>
                                         </div>
