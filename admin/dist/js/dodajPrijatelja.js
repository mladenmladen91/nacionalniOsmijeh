$(document).ready(function(){
    ...
    // submitting form
     $("form").submit(function(e){
            ...
            saveFriend(formData, tableName, page);
    });
});

// saving album
function saveFriend(formData, tableName, page){
        
        swal("Jeste li sigurni da želite da dodate prijatelja?", {
                buttons: {
                    cancel: "Ne",
                    catch: {
              ...
              $.ajax({
                ...
                success: function (returndata) {
                    ...
                    if(returndata !== "Success"){
                        ...
                        swal("Prijatelj dodat!", "Uspješno ste dodali prijatelja!", "success").then(function(){
