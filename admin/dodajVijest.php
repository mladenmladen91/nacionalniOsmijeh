       ...
       <div class="container">
          <div class="row">   
           <div class="col-lg-12 table_holder">
              <div class="col-lg-12">  
                  <span class="footer_title underline">DODAJ VIJEST</span>
              </div>
              ...
              <div class="col-lg-12 p-0" style="margin-top:50px">
                    <form class="contact_form p-0" id="infoForm">
                                <input type="hidden" name="table" value="vijesti">
                              ...
                              <div class="col-lg-12">
                                <div class="row">  
                                 <div class="col-lg-12" style="padding-top: 40px">
                                     ...
                                     <a href="vijesti.php" class="giveup_btn text-center" title="Odustani"><i class="fas fa-times"></i>&ensp;ODUSTANI</a>
                                 </div>
                              </div>   
                              </div>      
                             </form> 
