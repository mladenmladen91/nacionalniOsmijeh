...
$stmt = mysqli_prepare($connection, "SELECT naslov, tekst, datum, fotografija FROM vijesti  WHERE id=? AND status='aktivan'");
...
<div class="section news_holder" style="margin-top: 100px">
    <div class="container-fluid p-0 photo_container_holder text-center">
...
">
        ...
        <div class="swiper-wrapper text-center" style="padding: 0">
          <?php
                                     $stmtSezone = mysqli_prepare($connection, "SELECT id, naslov, tekst, datum, fotografija, status FROM vijesti WHERE NOT id={$id} AND status='aktivan' ORDER BY datum DESC LIMIT 10");
                                     $stmtSezone->execute();
           ...
           <div class="swiper-slide">
              <div class="col-lg-8 p-0">   
               <a href="vijest.php?id=<?php echo $id ?>" title="<?php echo $naslov ?>">
                    <div style="position: relative">
                       <img class="card-img-top img-responsive" src="admin/images/vijesti/<?php echo $fotografija ?>" height="240" style="object-fit:cover; object-position:top" >
            ...
            ?>
                     <div class="col-lg-12 text-center article_title" >Nema ostalih vijesti</div>
            <?php } ?>
           </div>
      </div>
    <!-- Add Arrows -->
...
<script>
 ...
 $(document).ready(function(){
    ...
    if(screen >= 2000){
        $(".photo_container_holder img").css({
            "width": "50%"
        });
    }
