...
<div class="section">
    <div class="container news_container_holder">
        ...
        <?php    
              $stmtSezone = mysqli_prepare($connection, "SELECT id, naslov, tekst, datum, fotografija, status FROM postovi WHERE status='aktivan' ORDER BY datum DESC");
              ...
              <div class="row">
                   ...
                   <div class="col-xl-6 right_side" style="padding-left: 40px !important">
                      <a href="clanak.php?id=<?php echo $id ?>" title="<?php echo $naslov ?>">   
                       ...
                       <div class="col-lg-12 news_container_title">
                          <?php echo $naslov ?>
                       </div>
                       <div class="col-lg-12 news_container_text">
                          <?php echo $tekst ?>
                       </div>
                       </a>    
                       <div class="col-lg-12 news_container_link">
                           <a href="clanak.php?id=<?php echo $id ?>" title="<?php echo $naslov ?>">Pročitaj</a>
                       </div>
                   </div>
               </div>
           </div>
        ...
        ?>
            <div class="col-lg-12 article_title text-center" style="min-height: 200px">NEMA POSTOVA</div>
        <?php } ?>    
        </div>    
    </div>
</div>
